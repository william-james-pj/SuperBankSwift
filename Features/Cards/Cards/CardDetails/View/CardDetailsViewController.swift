...
public protocol CardDetailsVCDelegate: AnyObject {
    func reloadCards()
}
...
public class CardDetailsViewController: UIViewController {
    ...
    public weak var delegate: CardDetailsVCDelegate?
    ...
    private func setupTableView() {
        ...
        tableView.register(
            CardLockTableViewCell.self,
            forCellReuseIdentifier: CardLockTableViewCell.reuseIdentifier
        )
        tableView.register(
            CardDetailsHeader.self,
            forHeaderFooterViewReuseIdentifier: CardDetailsHeader.reuseIdentifier
        )
    }
    ...
    private func settingCardLock() {
        ...
        let obj1 = CardLockModel(
            title: "Bloqueiro temporário",
            keyName: "isEnabled",
            activeStatus: "Bloqueado",
            disabledStatus: "Desbloqueado",
            isActive: card.isEnabled
        )
        let obj2 = CardLockModel(
            title: "Compras internacionais",
            keyName: "isInternationalPurchasesEnabled",
            activeStatus: "Bloqueadas",
            disabledStatus: "Desbloqueadas",
            isActive: card.isInternationalPurchasesEnabled
        )
...
extension CardDetailsViewController: UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(
            withIdentifier: CardLockTableViewCell.reuseIdentifier,
            for: indexPath
        ) as! CardLockTableViewCell
    ...
    public func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        if section == 0 {
            let view = tableView.dequeueReusableHeaderFooterView(
                withIdentifier: CardDetailsHeader.reuseIdentifier
            ) as! CardDetailsHeader
