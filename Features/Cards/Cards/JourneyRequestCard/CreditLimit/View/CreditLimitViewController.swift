...
public class CreditLimitViewController: UIViewController {
    ...
    private func settingCreditValue() {
        ...
        let textFormated = self.viewModel.formatCurrency(value)
        
        self.labelSubText.text = "\(textFormated) disponivel para uso."
        self.textFieldCreditValue.text = textFormated
