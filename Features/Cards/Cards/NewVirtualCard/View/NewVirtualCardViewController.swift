...
public class NewVirtualCardViewController: UIViewController {
    ...
    private let labelInfo: UILabel = {
        let attrString = NSMutableAttributedString(string: "Dê um nome personalizado para organizar e identificar as compras que você faz em cada cartão virtual.")
    ...
    private let labelCaracteres: UILabel = {
        let label = UILabel()
        label.text = "0/20"
        label.font = .systemFont(ofSize: 14, weight: .regular)
        label.textColor = UIColor(named: "Disabled")
    ...
    private let buttonNewCard: ButtonPrimary = {
    ...
    // MARK: - Methods
    private func settingLabelCaracters(_ number: Int) {
        self.labelCaracteres.text = "\(number)/20"
    }
    ...
    private func buildHierarchy() {
        ...
        view.addSubview(labelCaracteres)
    ...
    private func buildConstraints() {
        NSLayoutConstraint.activate([
            ...
            labelCaracteres.widthAnchor.constraint(equalToConstant: 40),
            labelCaracteres.topAnchor.constraint(equalTo: textFieldCardName.bottomAnchor, constant: 8),
            labelCaracteres.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -16),
            ...
            labelInputInfo.trailingAnchor.constraint(equalTo: labelCaracteres.leadingAnchor, constant: -16),
        ])
    }
}
...
extension NewVirtualCardViewController: UITextFieldDelegate {
    public func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool
    {
        ...
        if let updatedString = updatedString {
            ...
            self.settingLabelCaracters(updatedString.count)
