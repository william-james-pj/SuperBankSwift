...
class CardServiceMock: CardNetwork {
    ...
    func getAllCard(accountId: String) async throws -> [CardModel] {
        let card1 = CardModel(cardId: "", accountId: "", cardName: "", cardNumber: "", cvc: "", expireDate: "", isEnabled: true, isInternationPurchasesEnabled: true, cardType: .physical, nickname: "")
        let card2 = CardModel(cardId: "", accountId: "", cardName: "", cardNumber: "", cvc: "", expireDate: "", isEnabled: true, isInternationPurchasesEnabled: true, cardType: .virtual, nickname: "")
        return [card1, card2]
    }
