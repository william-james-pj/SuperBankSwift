...
protocol HeaderHomeTableViewCellDelegate: AnyObject {
    func openDrawerMenu()
...
class HeaderHomeTableViewCell: UITableViewCell {
    // MARK: - Constraints
    static let reuseIdentifier: String = "HomeHeaderTableViewCell"

    // MARK: - Variables
    weak var delegate: HeaderHomeTableViewCellDelegate?
