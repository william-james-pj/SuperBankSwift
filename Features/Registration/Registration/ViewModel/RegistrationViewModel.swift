...
class RegistrationViewModel {
    ...
    func formatBirthDateMask(_ birthDate: String) -> String {
        ...
        for char in mask where index < cleanBirthDate.endIndex {
            if char == "#" {
    ...
    func formatPhoneNumberMask(_ phoneNumber: String) -> String {
