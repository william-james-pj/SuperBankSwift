...
class RegistrationUITests: XCTestCase {
    ...
    func testFullNameRegistrationVC_WhenViewLoaded_RequiredUIElementsAreEnabled() {
        ...
        XCTAssertTrue(textFieldFullName.isEnabled, "FullName UITextField in FullNameRegistrationViewController is not enabled for user interactions")
        XCTAssertFalse(buttonGOFullName.isEnabled, "GO UIButton in FullNameRegistrationViewController is enabled for user interactions when FullName UITextField is not predefined")
    }
    ...
    func testCPFVCRegistration_WhenViewLoaded_RequiredUIElementsAreEnabled() {
        ...
        XCTAssertTrue(isExistence, "The FullNameRegistrationViewController was not presented")
        XCTAssertTrue(textFieldCPF.isEnabled, "CPF UITextField in CPFVCRegistrationViewController is not enabled for user interactions")
        XCTAssertFalse(buttonGOCPF.isEnabled, "GO UIButton in CPFVCRegistrationViewController is enabled for user interactions when CPF UITextField is not predefined")
    }
    ...
    func testBirthDate_WhenViewLoaded_RequiredUIElementsAreEnabled() {
        ...
        XCTAssertTrue(textFieldBirthDate.isEnabled, "BirthDate UITextField in BirthDateRegistrationViewController is not enabled for user interactions")
        XCTAssertFalse(buttonGOBirthDate.isEnabled, "GO UIButton in BirthDateRegistrationViewController is enabled for user interactions when BirthDate UITextField is not predefined")
    }
    ...
    func testPhoneNumber_WhenViewLoaded_RequiredUIElementsAreEnabled() {
        ...
        XCTAssertTrue(textFieldPhoneNumber.isEnabled, "PhoneNumber UITextField in PhoneNumberRegistrationViewController is not enabled for user interactions")
        XCTAssertFalse(buttonGOPhoneNumber.isEnabled, "GO UIButton in PhoneNumberRegistrationViewController is enabled for user interactions when PhoneNumber UITextField is not predefined")
    }
